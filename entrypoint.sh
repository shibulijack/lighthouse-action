...
# Run Lighthouse!
lighthouse --port=9222 --chrome-flags="--headless --disable-gpu --no-sandbox --no-zygote" --emulated-form-factor=none --output "html" --output "json" --output-path "${OUTPUT_PATH}" "${REPORT_URL}"
