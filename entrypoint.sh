...
# Run Lighthouse!
lighthouse --port=9222 --emulated-form-factor=none --disable-network-throttling --chrome-flags="--headless --disable-gpu --no-sandbox --no-zygote" --output "html" --output "json" --output-path "${OUTPUT_PATH}" "${REPORT_URL}"
